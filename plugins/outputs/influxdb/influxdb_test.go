...
type MockClient struct {
	URLF            func() string
	WriteF          func(context.Context, []internal.Metric) error
...
func (c *MockClient) Write(ctx context.Context, metrics []internal.Metric) error {
	...
	output := influxdb.InfluxDB{
		...
		CreateHTTPClientF: func(config *influxdb.HTTPConfig) (influxdb.Client, error) {
			return &MockClient{
				...
				WriteF: func(ctx context.Context, metrics []internal.Metric) error {
