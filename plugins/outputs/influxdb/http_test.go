...
func TestHTTP_CreateDatabase(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			queryHandlerFunc: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				require.Equal(t, `CREATE DATABASE "straw"`, r.FormValue("q"))
				w.WriteHeader(http.StatusOK)
				w.Write(successResponse)
			},
		},
...
func TestHTTP_Write(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			queryHandlerFunc: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				require.Equal(t, r.FormValue("db"), "straw")
		...
		},
		{
			...
			queryHandlerFunc: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				require.Equal(t, r.Header.Get("User-Agent"), "straw")
				w.WriteHeader(http.StatusNoContent)
			},
		},
		{
			...
			queryHandlerFunc: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				require.Equal(t, r.Header.Get("User-Agent"), "Straw/1.2.3")
				w.WriteHeader(http.StatusNoContent)
			},
		},
		{
			...
			queryHandlerFunc: func(t *testing.T, w http.ResponseWriter, r *http.Request) {
				require.Equal(t, "straw", r.FormValue("db"))
				w.WriteHeader(http.StatusNoContent)
			},
		},
		{
...
func TestHTTP_UnixSocket(t *testing.T) {
	tmpdir, err := ioutil.TempDir("", "straw-test")
	if err != nil {
		require.NoError(t, err)
	}
