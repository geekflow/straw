...
const (
	defaultURL = "http://127.0.0.1:8080/straw"
)

var sampleConfig = `
  ## URL is the address to send metrics to
  url = "http://127.0.0.1:8080/straw"
  ...
  ## https://github.com/influxdata/straw/blob/master/docs/DATA_FORMATS_OUTPUT.md
  # data_format = "influx"
...
func (h *HTTP) Write(metrics []internal.Metric) error {
...
func (h *HTTP) write(reqBody []byte) error {
	...
	req.Header.Set("User-Agent", "Straw/"+internal.Version())
...
func init() {
	outputs.Add("http", func() plugins.Output {
		return &HTTP{
