...
func TestDiskStats(t *testing.T) {
	...
	mps.On("DiskUsage", []string(nil), []string(nil)).Return(duFiltered, psFiltered, nil)
	mps.On("DiskUsage", []string(nil), []string(nil)).Return(duAll, psAll, nil)
