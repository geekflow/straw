...
func (s *Serializer) Serialize(m internal.Metric) ([]byte, error) {
	s.buf.Reset()
...
func (s *Serializer) SerializeBatch(metrics []internal.Metric) ([]byte, error) {
	s.buf.Reset()
...
func (s *Serializer) Write(w io.Writer, m internal.Metric) (int, error) {
...
func (s *Serializer) buildHeader(m internal.Metric) error {
	s.header = s.header[:0]
...
func (s *Serializer) buildFooter(m internal.Metric) {
	s.footer = s.footer[:0]
...
func (s *Serializer) writeMetric(w io.Writer, m internal.Metric) error {
	var err error
