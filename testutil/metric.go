...
func newMetricDiff(metric internal.Metric) *metricDiff {
	if metric == nil {
		return nil
	}
...
func MetricEqual(expected, actual internal.Metric, opts ...cmp.Option) bool {
...
// equal.
func RequireMetricEqual(t *testing.T, expected, actual internal.Metric, opts ...cmp.Option) {
	t.Helper()
...
// are not equal.
func RequireMetricsEqual(t *testing.T, expected, actual []internal.Metric, opts ...cmp.Option) {
	t.Helper()
...
func FromTestMetric(met *Metric) internal.Metric {
