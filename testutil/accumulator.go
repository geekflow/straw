...
func (a *Accumulator) GetTelegrafMetrics() []internal.Metric {
...
func (a *Accumulator) AddFields(
	...
	a.addFields(measurement, tags, fields, internal.Untyped, timestamp...)
}
...
func (a *Accumulator) AddCounter(
	...
	a.addFields(measurement, tags, fields, internal.Counter, timestamp...)
}
...
func (a *Accumulator) AddGauge(
	...
	a.addFields(measurement, tags, fields, internal.Gauge, timestamp...)
}

func (a *Accumulator) AddMetrics(metrics []internal.Metric) {
...
func (a *Accumulator) AddSummary(
	...
	a.addFields(measurement, tags, fields, internal.Summary, timestamp...)
}
...
func (a *Accumulator) AddHistogram(
	...
	a.addFields(measurement, tags, fields, internal.Histogram, timestamp...)
}
...
func (a *Accumulator) GatherError(gf func(plugins.Accumulator) error) error {
	if err := gf(a); err != nil {
		return err
	}
	if len(a.Errors) > 0 {
